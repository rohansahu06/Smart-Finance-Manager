...
export default function DepositePage() {
    ...
    const [verificationStep, setVerificationStep] = useState("credentials");
    ...
    const handleOTPSubmit = async (e) => {
        ...
        try {
            ...
            if (data.verified) {
                alert("Transaction verification successful.");
    ...
    const handleWithdrawRequest = async () => {
        ...
        try {
            ...
            alert("Withdraw OTP sent to your registered email.");
            setWithdrawOTP("");
            setVerificationStep("withdraw-otp");
        } catch (error) {
    ...
    const handleWithdrawOTPSubmit = async (e) => {
        ...
        try {
            ...
            const data = await response.json();
            if (!response.ok) {
                alert(data.message || "Invalid withdraw OTP.");
                return;
            }
            if (data.verified) {
    ...
    if (verificationStep === "withdraw-otp") {
        return (
            <div className="transaction-page">
                <div className="verification-container">
                    <div className="verification-card">
                        ...
                        <form
                            onSubmit={handleWithdrawOTPSubmit}
                            className="verification-form"
                        >
                            <div className="form-group">
